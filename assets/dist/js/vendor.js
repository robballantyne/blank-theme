...
try {
    window.$ = window.jQuery = jQuery = __webpack_require__(0);
    // Load jquery dependencies
    window.Slideout = __webpack_require__(1);
    $.fn.iziModal = __webpack_require__(6);
    window.select2 = __webpack_require__(8);
    window.octoberFramework = __webpack_require__(9); // October framework
    window.octoberFrameworkExtras = __webpack_require__(10); // October framework extras
} catch (e) {
